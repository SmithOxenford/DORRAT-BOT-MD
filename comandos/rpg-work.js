...
conn.sendButton(m.chat, `*${pickRandom(global.work)} $${d}* *DOLARES*`, wm, pp,
[['balance', `/bal`]], m)
...
"Ayudas a moderar el grupo de Makanaky por", "Diseñaste un logo para *FG* por", 
...
"Trabajas como podador de arbustos para *Adriano-Sánchez* y ganas", "La demanda de juegos para dispositivos móviles ha aumentado, por lo que creas un nuevo juego lleno de micro-transacciones. Con tu nuevo juego ganas un total de", 
